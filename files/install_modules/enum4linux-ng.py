...
## Summon Installation module for: Enum4Linux-NG
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/enum4linux-ng/enum4linux-ng.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/enum4linux-ng/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/cddmp/enum4linux-ng.git","/redteam/windows-domains/","enum4linux-ng"):
            self.python.pip_reqs("Enum4Linux-NG","/redteam/windows-domains/enum4linux-ng")
