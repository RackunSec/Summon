...
## Summon Installation module for: Coercer
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/Coercer/Coercer.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/Coercer/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.force: ## we are destroying all old artifacts:
            ...
            self.python.pip_uninstall("coercer")
        ...
        self.python.pip_install("coercer")
        self.apps.git_clone("https://github.com/p0dalirius/Coercer.git","/redteam/windows-domains/","Coercer")
