...
## Summon Installation module for: Atom IDE
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/bin/atom" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.files.download_file(self.apps.demonrepo+"atom-amd64.deb","/tmp/atom-amd64.deb",False) ## download it
        self.apps.dpkg_install("/tmp/atom-amd64.deb")
