...
## Summon Installation module for: Kerbrute
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/kerbrute" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.files.download_file("https://github.com/ropnop/kerbrute/releases/download/v1.0.3/kerbrute_linux_amd64","/redteam/windows-domains/kerbrute",False)
        os.chmod("/redteam/windows-domains/kerbrute",stat.S_IEXEC)
