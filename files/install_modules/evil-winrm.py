...
## Summon Installation module for: Evil-WinRM
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/evil-winrm" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.apps.ruby_gem_install(["evil-winrm"])
