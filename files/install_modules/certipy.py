...
## Summon Installation module for: Certipy
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/certipy" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/Certipy"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/ly4k/Certipy.git","/redteam/windows-domains/","Certipy"):
            os.chdir("/redteam/windows-domains/Certipy")
