...
## Summon Installation module for: PyLDAPSearch
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/pyldapsearch" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.python.pip_install("pyldapsearch")
    ...
    def uninstall(self):
        ...
        ##vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
        self.python.pip_uninstall("pyldapsearch")
