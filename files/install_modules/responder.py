...
## Summon Installation module for: Responder
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/Responder/Responder.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/Responder/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
        ##^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/lgandx/Responder.git","/redteam/windows-domains/","Responder")
