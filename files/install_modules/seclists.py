...
## Summon Installation module for: SecLists
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/wordlists/SecLists/LICENSE" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/wordlists/SecLists/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
        ##^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/danielmiessler/SecLists.git","/redteam/wordlists/","SecLists")
