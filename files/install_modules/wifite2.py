...
## Summon Installation module for: Wi-Fite2.py
...
class Application():
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/derv82/wifite2.git","/redteam/wifi/","wifite2"):
            os.chdir("/redteam/wifi/wifite2")
