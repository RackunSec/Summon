...
## Summon Installation module for: BatchQL
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/web/GraphQL/batchql/batch.py" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/assetnote/batchql.git","/redteam/web/GraphQL/","batchql")
