...
## Summon Installation module for: Ghostpack Binaries
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/Ghostpack-CompiledBinaries/Certify.exe" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/Ghostpack-CompiledBinaries/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/r3motecontrol/Ghostpack-CompiledBinaries.git","/redteam/windows-domains/","Ghostpack-CompiledBinaries")
