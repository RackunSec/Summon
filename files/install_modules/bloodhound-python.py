...
## Summon Installation module for: Bloodhound-Python
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/bloodhound-python" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        if self.force: ## we are destroying all old artifacts:
            ...
            self.python.pip_uninstall("bloodhound")
        ...
        self.python.pip_install("bloodhound")  
