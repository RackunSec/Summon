...
## Summon Installation module for: DBeaver
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/bin/dbeaver" ## This file will exist when the application is properly installed.
        self.badpaths=["/tmp/dbeaver.deb"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.force: ## we are destroying all old artifacts:
            ...
            self.apps.apt_remove(["dbeaver-ce"])
        ...
        self.files.download_file(self.demon_repo+"dbeaver.deb","/tmp/dbeaver.deb",False)
        self.apps.dpkg_install("/tmp/dbeaver.deb") 
