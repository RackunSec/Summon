...
## Summon Installation module for: CoWPAtty
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/cowpatty" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/wifi/cowpatty"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/joswr1ght/cowpatty.git","/redteam/wifi/","cowpatty"):
            os.chdir("/redteam/wifi/cowpatty")
            self.apps.apt_install(["clang"]) ## This is required to build this project
