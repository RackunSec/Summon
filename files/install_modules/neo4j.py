...
## Summon Installation module for: Neo4j
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/bin/neo4j" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.apps.apt_add_repo("deb http://httpredir.debian.org/debian stretch-backports main","/etc/apt/sources.list.d/stretch-backports.list")
        self.apps.apt_update() ## Update now that the repo is added
        self.apps.apt_install(["openjdk-11-jre"]) ## Install Java
        self.apps.apt_key_add("https://debian.neo4j.com/neotechnology.gpg.key")
        self.apps.apt_add_repo("deb https://debian.neo4j.com stable latest","/etc/apt/sources.list.d/neo4j.list")
        self.apps.apt_update() ## Update now that the repo is added
        self.apps.apt_install(["neo4j"])
