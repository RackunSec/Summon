...
## Summon Installation module for: DefaultCreds Cheat Sheet
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/passwords/DefaultCreds-cheat-sheet/creds" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/passwords/DefaultCreds-cheat-sheet"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/ihebski/DefaultCreds-cheat-sheet.git","/redteam/passwords/","DefaultCreds-cheat-sheet"):
            self.shell.run_cmd(["sed","-i","/hashlib/d","/redteam/passwords/DefaultCreds-cheat-sheet/requirements.txt"]) ## ?
            self.python.pip_reqs("DefaultCreds Cheat Sheet","/redteam/passwords/DefaultCreds-cheat-sheet/")
