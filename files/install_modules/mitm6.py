...
## Summon Installation module for: MitM6.py
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/mitm6/mitm6/mitm6.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/mitm6/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
        ##^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/dirkjanm/mitm6.git","/redteam/windows-domains/","mitm6"):
            self.python.pip_reqs("Mitm6","/redteam/windows-domains/mitm6/")
