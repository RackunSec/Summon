...
## Summon Installation module for: EyeWitness
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/web/EyeWitness/Python/EyeWitness.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/web/EyeWitness/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/FortyNorthSecurity/EyeWitness.git","/redteam/web/","EyeWitness"):
            os.chdir("/redteam/web/EyeWitness/Python/setup")
            os.chmod("/redteam/web/EyeWitness/Python/setup/setup.sh",stat.S_IEXEC)
            self.shell.run_cmd(["./setup.sh"])
