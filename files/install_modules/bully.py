...
## Summon Installation module for: Bully
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/bully" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/wifi/bully"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/aanarchyy/bully.git","/redteam/wifi/","bully"):
            os.chdir("/redteam/wifi/bully/src")
