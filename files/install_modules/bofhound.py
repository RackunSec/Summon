...
## Summon Installation module for: BOFhound
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/bofhound" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        if self.force: ## we are destroying all old artifacts:
            ## if install via pip, call Python.pip_uninstall(app)
            self.python.pip_uninstall("bofhound") ## Destroy it.
        ...
        self.python.pip_install("bofhound")
