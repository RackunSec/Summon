...
## Summon Installation module for: SprayCharles
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/passwords/spraycharles/spraycharles/spraycharles.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/passwords/spraycharles/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
        ##^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/Tw1sm/spraycharles.git","/redteam/passwords/","spraycharles")
        self.python.poetry_install("/redteam/passwords/spraycharles/","Spray Charles")
