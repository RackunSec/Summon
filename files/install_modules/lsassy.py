...
## Summon Installation module for: LSASSy
...
class Application():
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/Hackndo/lsassy.git","/redteam/windows-domains/","lsassy"):
            self.python.poetry_install("/redteam/windows-domains/lsassy","Lsassy")
            self.python.pip_reqs("Lsassy","/redteam/windows-domains/lsassy")
