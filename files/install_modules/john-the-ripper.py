...
## Summon Installation module for: JOhn the Ripper
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/passwords/john/run/john" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/passwords/john/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/openwall/john.git","/redteam/passwords/","john"):
            os.chdir("/redteam/passwords/john/src")
