...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/web/graphql-path-enum" ## This file will exist when the application is properly installed.
    ...
    def install(self):
        ...
        self.files.download_file("https://gitlab.com/dee-see/graphql-path-enum/-/jobs/artifacts/v1.1/raw/target/release/graphql-path-enum?job=build-linux","/redteam/web/graphql-path-enum",False)
        os.chmod("/redteam/web/graphql-path-enum",stat.S_IEXEC)
