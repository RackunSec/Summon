...
## Summon Installation module for: KrbRelayX
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/krbrelayx/krbrelayx.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/krbrelayx/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        self.apps.git_clone("https://github.com/dirkjanm/krbrelayx.git","/redteam/windows-domains/","krbrelayx")
