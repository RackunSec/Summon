...
## Summon Installation module for: Freeze
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/payloads/Freeze/Freeze" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/payloads/Freeze/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/optiv/Freeze.git","/redteam/payloads/","Freeze"):
            os.chdir("/redteam/payloads/Freeze")
            self.shell.run_cmd(["/usr/local/go/bin/go","build","Freeze.go"])
            os.chdir(self.apps.current_dir) ## Done, go back 
