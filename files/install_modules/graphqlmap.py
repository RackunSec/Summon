...
## Summon Installation module for: GraphQLMap
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/usr/local/bin/graphqlmap" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/www/GraphQL/GraphQLmap/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/swisskyrepo/GraphQLmap.git","/redteam/www/GraphQL/","GraphQLmap"):
            os.chdir("/redteam/www/GraphQL/GraphQLmap/")
