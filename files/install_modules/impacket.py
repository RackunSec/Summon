...
## Summon Installation module for: Impacket
...
class Application():
    def __init__(self,force):
        ...
        self.install_path_check ="/redteam/windows-domains/impacket/examples/secretsdump.py" ## This file will exist when the application is properly installed.
        self.badpaths=["/redteam/windows-domains/impacket/"] ## Destroy local repo (/redteam/(CATEGORY)/repo) and binary in $PATH.
    ...
    def install(self):
        ...
        if self.apps.git_clone("https://github.com/SecureAuthCorp/impacket.git","/redteam/windows-domains/","impacket"):
            self.python.pip_install_dot("/redteam/windows-domains/impacket")
